...
export default function FOCashModulePage() {
  ...
  const renderFormView = () => (
    <div className="flex-1 overflow-auto">
      <PageHeader
        title="F&O Cash Module - New Entry"
        description="Add new F&O cash receipt or payment"
        action={
          <Button
      ...
      <div className="p-6">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2" style={{ color: "#9333ea" }}>
              <Plus className="w-5 h-5" />
              Add F&O Cash Receipt / Payment
            </CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleCreateCash} className="grid gap-4 md:grid-cols-1 lg:grid-cols-5">
              ...
              <div className="space-y-2 lg:col-span-5">
                ...
                <Textarea
                  ...
                  rows={2}
                  placeholder="Reason / details of F&O cash transaction"
                />
              </div>
  ...
  const renderListView = () => (
    <div className="flex-1 overflow-auto">
      <PageHeader
        title="F&O Cash Module"
        description="Manage F&O cash receipts/payments, view daily cash book and recent transactions"
        action={
          <Button
            onClick={() => {
            ...
            className="bg-[#9333ea] hover:bg-[#7e2bd4] group relative"
          >
            <Plus className="w-4 h-4 mr-2" />
            Add F&O Cash Entry
          </Button>
