...
const EquityInterest = () => {
  ...
  const calculateInterest = async () => {
    ...
    setIsLoading(true);
    try {
      let url = `http://localhost:3001/api/interest?from_date=${fromDate}&to_date=${toDate}&module=equity`;
  ...
  return (
    <div className="flex-1 overflow-auto">
      <PageHeader
        title="Equity Interest Management"
        description="Calculate interest on outstanding balances for parties (Equity Module)"
        action={null}
      />
